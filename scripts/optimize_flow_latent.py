...
from flow_matching.optimization import QH_OPTIMIZATION_DEFAULTS  # noqa: E402
...
from scripts.native_score_runtime import (  # noqa: E402
    append_jsonl,
    file_sha256,
    token_case,
    write_json,
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Optimize a QH Flow latent with the validated 309-trajectory recipe: "
            "query-batched local CUDA endpoints and formally rescored centers."
        )
    )
    ...
    parser.add_argument(
        ...
        default=QH_OPTIMIZATION_DEFAULTS.gradient_mode,
    )
    parser.add_argument(
        "--random-directions", type=int, default=QH_OPTIMIZATION_DEFAULTS.directions
    )
