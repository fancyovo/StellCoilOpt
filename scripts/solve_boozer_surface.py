...
from scripts.desc_support import load_psi_model
from scripts.boozer_residual import GpuBOnlyFieldAdapter
from scripts.guard_boozer_surface import evaluate_state, surface_from_dofs
...
def main() -> None:
    ...
    parser.add_argument(
        "--gpu-lib",
        type=Path,
        default=ROOT / "gpu_backend" / "build_native_score" / "libstellarator_gpu.so",
    )
