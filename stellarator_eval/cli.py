...
def build_parser():
    ...
    p.add_argument("--psi-gpu-lib", default="gpu_backend/build_native_score/libstellarator_gpu.so")
    ...
    p.add_argument("--axis-gpu-lib", default="gpu_backend/build_native_score/libstellarator_gpu.so")
    ...
    p.add_argument("--screen-gpu-lib", default="gpu_backend/build_native_score/libstellarator_gpu.so")
    ...
    p.add_argument("--surface-gpu-lib", default="gpu_backend/build_native_score/libstellarator_gpu.so")
